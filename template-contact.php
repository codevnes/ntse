...
<main id="primary" class="site-main contact-page water-treatment-theme">
    <header class="contact-page__header water-effect-header" data-animate="fadeInUp">
        ...
        <div class="container">
            <div class="contact-page__header-content service-header-content">
                ...
                <h1 class="contact-page__title page-title"><?php the_title(); ?></h1>
                <p class="contact-page__subtitle page-description">Hãy liên hệ với chúng tôi để được tư vấn về giải pháp xử lý nước tốt nhất cho bạn</p>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="contact-page__grid">
                <section class="contact-page__info">
                    ...
                    <?php
                    // Placeholder for contact info - Replace with theme options or ACF fields
                    $address = get_theme_mod('contact_address', '123 Đường ABC, Quận XYZ, Thành phố HCM');
                    $phone = get_theme_mod('contact_phone', '0123 456 789');
                    $email = get_theme_mod('contact_email', 'info@xulynuoc.com');
                    $working_hours = get_theme_mod('contact_hours', 'Thứ Hai - Thứ Sáu: 8:00 - 17:30');
                    ?>
                    ...
                    <div class="contact-page__services">
                        ...
                        <ul class="contact-page__services-list">
                            <li class="contact-page__services-item"><i class="fas fa-check"></i> <span>Xử lý nước sinh hoạt</span></li>
                            <li class="contact-page__services-item"><i class="fas fa-check"></i> <span>Xử lý nước công nghiệp</span></li>
                            <li class="contact-page__services-item"><i class="fas fa-check"></i> <span>Hệ thống lọc RO</span></li>
                            <li class="contact-page__services-item"><i class="fas fa-check"></i> <span>Bảo trì hệ thống nước</span></li>
                        </ul>
                    </div>
                ...
                <section class="contact-page__form-section">
                    ...
                    <div class="contact-page__form-container">
                        <?php
                        // Placeholder for contact form - Replace with shortcode or form function
                        // echo do_shortcode('[your_contact_form_shortcode]');
                        ?>
    ...
    <section class="contact-page__map">
        ...
        <div class="contact-page__map-wrapper">
            <?php
            // Placeholder for map - Replace with iframe or Map Block/Plugin
            $map_iframe = get_theme_mod('contact_map_iframe', '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.4478896189677!2d106.6271430748042!3d10.776988889371922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317529e4a15a886b%3A0x35e5a5480416b0e5!2zQ8O0bmcgVHkgVE5ISCBHaeG6o2kgUGjDoXAgQ8O0bmcgTmdo4buHIE5hbSBLaMawxqFuZw!5e0!3m2!1svi!2s!4v1719550795099!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>');
            echo $map_iframe; // Make sure to sanitize iframe content if fetched dynamically
            ?>
        </div>
    </section>
    ...
    <section class="contact-page__cta">
        <div class="container">
            <div class="contact-page__cta-content">
                <h2 class="contact-page__cta-title">Giải pháp xử lý nước toàn diện</h2>
                <p class="contact-page__cta-text">Chúng tôi cung cấp dịch vụ tư vấn, thiết kế và lắp đặt hệ thống xử lý nước chất lượng cao</p>
                <a href="#" class="contact-page__btn contact-page__btn--secondary btn-water-ripple">Tìm hiểu thêm</a>
            </div>
        </div>
    </section>
</main><!-- #main -->
